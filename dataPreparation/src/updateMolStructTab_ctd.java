 ...
 * Date: 12/13/12
 * Time: 9:12 AM
 * Change input of the program. No change in the program itself.
 */
public class updateMolStructTab_ctd {

        final public static String EXCELFILE="C:\\JShen\\Research\\EDKB\\ER\\DEAC\\120213\\CTD_er_all.xls";
        final public static String SHEETNAME="newCMPD";
        ...
        public static int addedNo=5001994;
...
//            System.out.println(rs.getArray("molregno"));
        ...
        public static ArrayList searchDECAByIckstr(String ickstr) {
            ...
            try{
                Class.forName(driver);
                Connection conn = DriverManager.getConnection(url+"deac_130211", user, password);
                Statement st= conn.createStatement();
...
//            System.out.println(rs.getArray("molregno"));
        ...
        public static String addMol(Molecule mol) throws Exception{
            ...
            Class.forName(driver);
            Connection conn1 = DriverManager.getConnection(url+"deac_130211", user, password);
...
//Convert ArrayList to 2D array:
            ...
            PrintWriter pw = new PrintWriter(new OutputStreamWriter(new FileOutputStream("C:\\JShen\\Research\\EDKB\\ER\\DEAC\\120213\\addCmpdRecs.txt")),true);
