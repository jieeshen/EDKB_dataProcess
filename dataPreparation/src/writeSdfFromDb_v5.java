 ...
 * Updated: Format the reference section, sort and merge continuous numbers
 *
 ...
 */
public class writeSdfFromDb_v5 {
    final public static String MOLLISTFILE="C:\\JShen\\Research\\EDKB\\ER\\Symyx\\120828\\molregnoList.txt";
    final public static String OUTPUTSDFILE="C:\\JShen\\Research\\EDKB\\ER\\Symyx\\120828\\erad_120828_compact_2.sdf";
    final public static String driver="com.mysql.jdbc.Driver";
    final public static String url="jdbc:mysql://localhost:3306/erad_120828";
    ...
    public static String formatRef(ArrayList<Integer> list){
        Collections.sort(list);
        int begin=0,end=0,temp=0;
        int count=0;
        begin=list.get(0);
        temp=begin;
        String ref="["+Integer.toString(begin);
        ...
        for (int i=1;i<list.size();i++){
            if (list.get(i)-temp==1){
                ...
                begin=list.get(i);
                ref=ref+Integer.toString(begin);
                temp=begin;
                count=0;
            }
        }
...
//        for(int i=1;i<=2;i++){
            ...
            while(rsA.next()){
                ...
                if (refpool.contains(ref_id)){
                    ...
                    switch (rsA.getString("ref_type").charAt(0)){
                        case 'j':
                            reference=rsA.getString("journal")+" "+rsA.getString("year")+", "+
                                    rsA.getString("volume")+": "+rsA.getString("first_page")+".\n";
                            break;
                        case 'd':
                        case 'w':
                            reference=rsA.getString("url")+" "+rsA.getString("year")+".\n";
                            break;
                        case 'p':
                            reference=rsA.getString("journal")+" "+rsA.getString("year")+".\n";
                            break;
                            ...
                            case 'a': // ER alpha
                                ...
                                switch(pl.charAt(0)){
                                    case 'F':
                                        ...
                                        String activityinfof=new String();   //full activity information
            ...
            for(int j=0;j<b_a_f.size();j++){
                ...
                String formatted_vd=activities[1]+" "+formatRef(b_a_f_ref.get(j));
            ...
            for(int j=0;j<b_b_f.size();j++){
                ...
                m.setProperty(valueTitle,activities[0]);
                String formatted_vd=activities[1]+" "+formatRef(b_b_f_ref.get(j));
                m.setProperty(descTitle,formatted_vd);
            }
            ...
            for(int j=0;j<b_a_l.size();j++){
                ...
                m.setProperty(valueTitle,activities[0]);
                String formatted_vd=activities[1]+" "+formatRef(b_a_l_ref.get(j));
                m.setProperty(descTitle,formatted_vd);
            }
            ...
            for(int j=0;j<b_b_l.size();j++){
                ...
                m.setProperty(valueTitle,activities[0]);
                String formatted_vd=activities[1]+" "+formatRef(b_b_l_ref.get(j));
                m.setProperty(descTitle,formatted_vd);
            }
            for(int j=0;j<b_a_u.size();j++){
                ...
                m.setProperty(valueTitle,activities[0]);
                String formatted_vd=activities[1]+" "+formatRef(b_a_u_ref.get(j));
                m.setProperty(descTitle,formatted_vd);
            }
            ...
            for(int j=0;j<b_b_u.size();j++){
                ...
                m.setProperty(valueTitle,activities[0]);
                String formatted_vd=activities[1]+" "+formatRef(b_b_u_ref.get(j));
            ...
            for(int j=0;j<b_u.size();j++){
                ...
                m.setProperty(valueTitle,activities[0]);
                String formatted_vd=activities[1]+" "+formatRef(b_u_ref.get(j));
                m.setProperty(descTitle,formatted_vd);
            }
            ...
            for(int j=0;j<r_a.size();j++){
                ...
                m.setProperty(valueTitle,activities[0]);
                String formatted_vd=activities[1]+" "+formatRef(r_a_ref.get(j));
                m.setProperty(descTitle,formatted_vd);
            }
            for(int j=0;j<r_b.size();j++){
                ...
                m.setProperty(valueTitle,activities[0]);
                String formatted_vd=activities[1]+" "+formatRef(r_b_ref.get(j));
                m.setProperty(descTitle,formatted_vd);
            }
            ...
            for(int j=0;j<r_u.size();j++){
                ...
                m.setProperty(valueTitle,activities[0]);
                String formatted_vd=activities[1]+" "+formatRef(r_u_ref.get(j));
                m.setProperty(descTitle,formatted_vd);
            }
            ...
            for(int j=0;j<c.size();j++){
                ...
                m.setProperty(valueTitle,activities[0]);
                String formatted_vd=activities[1]+" "+formatRef(c_ref.get(j));
                m.setProperty(descTitle,formatted_vd);
            }
