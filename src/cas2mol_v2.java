 ...
 * This version is used to generate a sdf file with the same orders of input list. Even the CAS is illegal, the output
 * will displayed. Users can replace the CAS by the chemical name or other string identities to make the program recognize
 * the chemical structures.
 *
 * Different from previous version, it will not check the duplicated CAS numbers.
 *
 *
...
public class cas2mol_v2 {
    ...
    public static void main(String args[]) throws Exception{
        ...
        int i=0;
        String inputFile="C:\\JShen\\Research\\EDKB\\ER\\DEAC\\120213\\newComp.txt";
        String outSdFile="C:\\JShen\\Research\\EDKB\\ER\\DEAC\\120213\\newComp.sdf";
        String outputFile="C:\\JShen\\Research\\EDKB\\ER\\DEAC\\120213\\newComp.log";
        String casTitle="CAS";
        String separator="\t";
