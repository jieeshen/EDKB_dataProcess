...
public class genNewSdf {
    final public static String INPUTSDFILE="C:\\Temp_data2\\all_EDKB_Xu_named.sdf";
    final public static String OUTPUTSDFILE="C:\\Temp_data2\\all_EDKB_Xu_named_NEW_120606.sdf";
...
//            System.out.println(mol.properties().get("PK"));        \
            ...
            System.out.print(MolExporter.exportToFormat(mol,"inchi").split("=")[1] );
            System.out.println(MolExporter.exportToFormat(mol,"inchikey").split("=")[1] );
//            String molfile=MolExporter.exportToFormat(mol,"mol");
